 ...
 *    a large list of objects. Copy the contents of that file below and start
 *    writing your script below that.
 ...
 *    code below. Once you have written your function, it should output the
 *    right answer.
 *
 */
